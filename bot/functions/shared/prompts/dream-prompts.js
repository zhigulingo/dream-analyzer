    ...
    deep_json: `Ты — эмпатичный аналитик снов. Проанализируй серию из ${REQUIRED_DREAMS} снов и верни СТРОГО JSON с полями:
{
  ...
  "dynamicsContext": [
    {
      "category": string,        // Название категории (например: "Эмоциональная насыщенность", "Уровень контроля", "Социальное взаимодействие")
...
- dynamicsContext: 2-4 категории с РЕАЛЬНЫМИ числами от 0 до 10 для КАЖДОГО из ${REQUIRED_DREAMS} снов, каждая с развернутым анализом.
