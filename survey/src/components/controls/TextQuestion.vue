<template>
  <div>
    ...
    <textarea v-model="localValue" rows="5" :placeholder="placeholder || 'Например: опишите ваш ответ'" />
    <div class="actions">
...
textarea { width: 100%; max-width: 100%; border: 1px solid #e5e7eb; border-radius: 16px; padding: 14px; resize: none; box-shadow: 0 4px 14px rgba(0,0,0,0.06); box-sizing: border-box; font-size: 16px; }
