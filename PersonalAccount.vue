<template>
  <div class="personal-account">
    ...
    <div v-if="profile" class="account-details">
      ...
      <!-- ИЗМЕНЕНИЕ ЗДЕСЬ: Кнопка всегда видна -->
      <button v-if="true" @click="openDeepAnalysisModal" :disabled="isDeepAnalysisLoading" class="deep-analysis-button">
...
// --- ИЗМЕНЕНО: Функция всегда возвращает true ---
const shouldShowDeepAnalysisButton = () => {
  return true;
};

// --- УДАЛЕНО: Watch за history ---
