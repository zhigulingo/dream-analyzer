    ...
    deep_json: `Ты — эмпатичный аналитик снов. Проанализируй серию из ${REQUIRED_DREAMS} снов и верни СТРОГО JSON с полями:
{
  ...
  "conclusions": string[],  // 3-5 ключевых выводов (каждый вывод - 2-3 предложения)
  "recommendations": [
    {
      "title": string,      // Краткое название рекомендации (3-5 слов)
      "description": string,  // Подробное объяснение (2-3 предложения) - что конкретно делать
      "rationale": string   // Почему это важно на основе анализа (1-2 предложения)
    }
  ]
}
