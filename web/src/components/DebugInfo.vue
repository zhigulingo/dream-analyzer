<template>
  <div class="debug-info" v-if="showDebug">
    <h3>Debug Information (Web)</h3>
    <div class="debug-item">
      <strong>API Base URL:</strong> {{ apiBaseUrl || 'NOT SET' }}
    </div>
    <div class="debug-item">
      <strong>Refresh Token URL:</strong> {{ refreshTokenUrl || 'NOT SET' }}
    </div>
    <div class="debug-item">
      <strong>Logout URL:</strong> {{ logoutUrl || 'NOT SET' }}
    </div>
    <div class="debug-item">
...
const refreshTokenUrl = computed(() => import.meta.env.VITE_REFRESH_TOKEN_API_URL)
const logoutUrl = computed(() => import.meta.env.VITE_LOGOUT_API_URL)
