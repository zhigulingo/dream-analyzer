<template>
  ...
  >
    ...
    <div class="px-8 md:px-16 py-4 flex justify-between"
         :class="[isOpen ? 'items-start fade-seq is-open seq-offset-0' : 'items-center']">
    ...
    <div class="absolute left-4 right-4 bottom-4 space-y-2 transition-opacity duration-300 transform"
         :class="isOpen ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6 pointer-events-none'">
      <button
